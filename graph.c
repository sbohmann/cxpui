...
static void on_activate(GtkApplication *app, gpointer user_data) {
  ...
  GtkWidget *drawing_widget = graph_widget_new();
  ...
  gtk_window_set_child(GTK_WINDOW(window), drawing_widget);

  // Connect the snapshot signal to render the custom graphics
  g_signal_connect(drawing_widget, "snapshot", G_CALLBACK(graph_widget_snapshot), NULL);
